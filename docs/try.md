...
=== "Fish"
    ...
    ```fish
    curl -sL in-1.cc | source - in-1 --local
    ```
...
| **[4](#cljr){ #cljr }** | **[`cljr`](https://clojure.org/about/clojureclr)** | [ClojureCLR](https://clojure.org/about/clojureclr) | .NET | **`in-1 cljr && cljr`** |
| **[5](#cljgo){ #cljgo }** | **[`cljgo`](https://muthuishere.github.io/cljgo/)** | [cljgo](https://muthuishere.github.io/cljgo/) | Go | **`in-1 cljgo && cljgo repl`** |
| **[6](#fennel){ #fennel }** | **[`fennel`](https://fennel-lang.org/)** | [Fennel](https://fennel-lang.org/) | Lua | **`in-1 fennel && fennel`** |
| **[7](#glj){ #glj }** | **[`glj`](https://github.com/glojurelang/glojure)** | [Glojure](https://github.com/glojurelang/glojure) | Go | **`in-1 glj && glj`** |
